...
public static class BossRelicRules
{
    ...
    private static readonly CounterId Docket = new("unfinished_docket");
    private static readonly CounterId Sash = new("priority_sash");
    private static readonly CounterId Disc = new("ivory_number_disc");
    private static readonly CounterId DiscHealth = new("ivory_number_disc_hp");
    private static readonly CounterId ExpeditionDone = new("expedition_writ_done");
    private static readonly CounterId WarrantDone = new("civic_warrant_done");
    private static readonly CounterId Continuance = new("continuance_fragment");
    private static readonly CounterId RedressStart = new("redress_opening_hp");
    private static readonly CounterId RedressPaid = new("redress_owed");
    private static readonly CounterId AppealDone = new("margin_of_appeal_done");
    private static readonly CounterId ErrataNow = new("errata_now");
    private static readonly CounterId ErrataLast = new("errata_last");
    private static readonly CounterId ErrataOwed = new("errata_owed");
    private static readonly CounterId Index = new("index_of_contradictions");
    private static readonly CounterId IndexLast = new("index_last_type");
    private static readonly CounterId Registered = new("registry_tab_type");
    private static readonly CounterId MinuteDebt = new("borrowed_minute_debt");
    private static readonly CounterId Writ = new("identity_writ");
    private static readonly CounterId Ledger = new("settled_ledger");
    private static readonly CounterId Premise = new("premise_slip_type");
    private static readonly CounterId Conclusion = new("conclusion_leaf_type");
    private static readonly CounterId Backlog = new("backlog_in_hand");
    private static readonly CounterId BellTurn = new("brass_bell_turn");
    private static readonly CounterId AppointmentTurn = new("appointment_turn");
    private static readonly CounterId KeyUsed = new("master_release_key_used");
