...
public static class BlueprintAssembler
{
    ...
    public static RunBlueprint Build(BabData data, int seed)
    {
        ...
        return new RunBlueprint(
            ...
            [.. data.Cards.Select(CardMapper.Map), .. ClauseCards.Cards(), NoticeCards.Acknowledge(), DeputyUndersecretary.ReviewCard(), .. QueueCommissioner.Cards(), .. LordSealkeeper.Cards(), .. MunicipalDragon.Cards()],
